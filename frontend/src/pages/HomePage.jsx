          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-10 relative">
              <div className="inline-block relative px-8 py-4">
                ...
                <span className="text-xs uppercase tracking-wider text-green-600 font-medium mb-2 block">Philosophie</span>
                <h2 className="heading-1 mb-0">Mon approche, ma vision et ma mission</h2>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-12 relative">
              <div className="inline-block relative px-8 py-4">
                ...
                <span className="text-xs uppercase tracking-wider text-green-600 font-medium mb-2 block">Mes services</span>
                <h2 className="heading-1 mb-0">Formats de consultations-rencontres proposées</h2>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8 relative">
              <div className="inline-block relative px-8 py-4">
                ...
                <span className="text-xs uppercase tracking-wider text-green-600 font-medium mb-2 block">Pour conclure</span>
                <h2 className="heading-1 mb-0">En résumé</h2>
              </div>
            </div>
